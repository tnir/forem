...
gem "blazer", "~> 2.6", ">= 2.6.3" # Allows admins to query data
...
gem "field_test", "~> 0.5", ">= 0.5.2" # A/B testing
...
gem "omniauth-apple", "~> 1.0", ">= 1.0.2" # OmniAuth strategy for Sign In with Apple
...
gem "rails", "~> 7.0.2.4" # Ruby on Rails
...
gem "sidekiq-cron", "~> 1.4", ">= 1.4.0" # Allows execution of scheduled cron jobs as specific times
...
group :development do
  ...
  gem "derailed_benchmarks", "~> 2.1", ">= 2.1.1", require: false # A series of things you can use to benchmark a Rails or Ruby app
...
group :development, :test do
  ...
  gem "cypress-rails", "~> 0.5", ">= 0.5.3" # For end to end tests (E2E)
  ...
  gem "rubocop-rails", "~> 2.14", ">= 2.14.2", require: false # Automatic Rails code style checking tool
