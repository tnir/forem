...
group :development, :test do
  ...
  gem "rubocop", "~> 1.66", ">= 1.66.0", require: false # Automatic Ruby code style checking tool
  ...
  gem "rubocop-rspec", "~> 3.0", ">= 3.0.0", require: false # Code style checking for RSpec files
