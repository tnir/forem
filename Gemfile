...
group :production do
  ...
  gem "rack-host-redirect", "~> 1.3", ">= 1.3.0" # Lean and simple host redirection via Rack middleware
end

gem "active_record_union", "~> 1.3", ">= 1.3.0" # Adds proper union and union_all methods to ActiveRecord::Relation
...
gem "ahoy_matey", "~> 4.1", ">= 4.1.0" # Tracking analytics for Rails
gem "ancestry", "~> 4.2", ">= 4.2.0" # Ancestry allows the records of a ActiveRecord model to be organized in a tree structure
gem "blazer", "~> 2.6", ">= 2.6.5" # Allows admins to query data
gem "bootsnap", ">= 1.1.0", require: false # Boot large ruby/rails apps faster
gem "carrierwave", "~> 2.2", ">= 2.2.2" # Upload files in your Ruby applications, map them to a range of ORMs, store them on different backends
...
gem "counter_culture", "~> 3.2", ">= 3.2.1" # counter_culture provides turbo-charged counter caches that are kept up-to-date
gem "ddtrace", "~> 1.3.0" # ddtrace is Datadog’s tracing client for Ruby.
gem "devise", "~> 4.8", ">= 4.8.1" # Flexible authentication solution for Rails
gem "devise_invitable", "~> 2.0.6" # Allows invitations to be sent for joining
gem "dogstatsd-ruby", "~> 4.8" # A client for DogStatsD, an extension of the StatsD metric server for Datadog
gem "email_validator", "~> 2.2", ">= 2.2.3" # Email validator for Rails and ActiveModel
...
gem "field_test", "~> 0.5", ">= 0.5.4" # A/B testing
gem "flipper", "~> 0.25.0" # Feature flipping / flags for Ruby
gem "flipper-active_record", "~> 0.25.2" # Store Flipper flags in ActiveRecord
gem "flipper-active_support_cache_store", "~> 0.25.2" # Cache feature flags for a short time
gem "flipper-ui", "~> 0.25.2" # UI for the Flipper gem
...
gem "inline_svg", "~> 1.8", ">= 1.8.0" # Embed SVG documents in your Rails views and style them with CSS
gem "jbuilder", "~> 2.11", ">= 2.11.5" # Create JSON structures via a Builder-style DSL
gem "js-routes", "~> 2.2", ">= 2.2.4" # Brings Rails named routes to javascript
gem "jsonapi-serializer", "~> 2.2", ">= 2.2.0" # Serializer for Ruby objects
...
gem "omniauth", "~> 2.1", ">= 2.1.0" # A generalized Rack framework for multiple-provider authentication
gem "omniauth-apple", "~> 1.2", ">= 1.2.0" # OmniAuth strategy for Sign In with Apple
gem "omniauth-facebook", "~> 9.0", ">= 9.0.0" # OmniAuth strategy for Facebook
gem "omniauth-github", "~> 2.0", ">= 2.0.1" # OmniAuth strategy for GitHub
gem "omniauth-google-oauth2", "~> 1.1", ">= 1.1.1" # OmniAuth strategy for Google OAuth2
gem "omniauth-rails_csrf_protection", "~> 1.0", ">= 1.0.1" # Provides CSRF protection on OmniAuth request endpoint on Rails application.
...
gem "pghero", "~> 2.8", ">= 2.8.3" # Dashboard for Postgres
gem "puma", "~> 5.6.4" # Puma is a simple, fast, threaded, and highly concurrent HTTP 1.1 server
gem "pundit", "~> 2.2", ">= 2.2.0" # Object oriented authorization for Rails applications
gem "rack-attack", "~> 6.6.1" # Used to throttle requests to prevent brute force attacks
gem "rack-cors", "~> 1.1", ">= 1.1.1" # Middleware that will make Rack-based apps CORS compatible
gem "rack-timeout", "~> 0.6" # Rack middleware which aborts requests that have been running for longer than a specified timeout
gem "rails", "~> 7.0.4.1" # Ruby on Rails
gem "ransack", "~> 3.2", ">= 3.2.1" # Searching and sorting
...
gem "rpush", "~> 7.0", ">= 7.0.1" # Push Notification library for Rails
gem "rpush-redis", "~> 1.2", ">= 1.2.0" # Redis module capability for rpush library
...
gem "sidekiq-cron", "~> 1.8", ">= 1.8.0" # Allows execution of scheduled cron jobs as specific times
...
gem "sprockets-rails", "~> 3.4", ">= 3.4.2" # Sprockets Rails integration
...
gem "strong_migrations", "~> 1.3", ">= 1.3.1" # Catch unsafe migrations
gem "twitter", "~> 7.0" # A Ruby interface to the Twitter API
gem "uglifier", "~> 4.2" # Uglifier minifies JavaScript files
gem "validate_url", "~> 1.0", ">= 1.0.15" # Library for validating urls in Rails
...
group :development do
  gem "better_errors", "~> 2.9", ">= 2.9.1" # Provides a better error page for Rails and other Rack apps
  ...
  gem "derailed_benchmarks", "~> 2.1", ">= 2.1.2", require: false # A series of things you can use to benchmark a Rails or Ruby app
  ...
  gem "web-console", "~> 4.2", ">= 4.2.0" # Rails Console on the Browser
...
group :development, :test do
  ...
  gem "bullet", "~> 7.0", ">= 7.0.3" # help to kill N+1 queries and unused eager loading
  gem "capybara", "~> 3.37.1" # Capybara is an integration testing tool for rack based web applications
  gem "cypress-rails", "~> 0.5", ">= 0.5.4" # For end to end tests (E2E)
  ...
  gem "rspec-rails", "~> 5.1", ">= 5.1.2" # rspec-rails is a testing framework for Rails 3+
  ...
  gem "rubocop-rails", "~> 2.16", ">= 2.16.1", require: false # Automatic Rails code style checking tool
...
group :test do
  ...
  gem "factory_bot_rails", "~> 6.2", ">= 6.2.0" # factory_bot is a fixtures replacement with a straightforward definition syntax, support for multiple build strategies
